...
#
# Generated by make_domsub_script.py, part of the chromium-build-system project:
# https://github.com/ungoogled-software/chromium-build-system.git
#
...
echo "Applying chromium-build-system domain substitution to %d files ..."
